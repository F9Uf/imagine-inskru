      ...
      .students .content .modal-fullscreen div.modal-content {
        ...
        .students .content .modal-fullscreen div.modal-content div.modal-header {
          ...
          .students .content .modal-fullscreen div.modal-content div.modal-header .close {
            ...
            margin-top: 10px;
            font-size: 14px; }
          .students .content .modal-fullscreen div.modal-content div.modal-header .modal-title {
            float: right; }
        .students .content .modal-fullscreen div.modal-content div.modal-body {
          ...
          .students .content .modal-fullscreen div.modal-content div.modal-body .citi-dish {
            border: 1px solid #00658e;
            font-size: 12px;
            padding: 10px;
            color: #fff;
            background-color: #008fc9; }
            .students .content .modal-fullscreen div.modal-content div.modal-body .citi-dish h4,
            .students .content .modal-fullscreen div.modal-content div.modal-body .citi-dish p {
              color: #fff; }
            .students .content .modal-fullscreen div.modal-content div.modal-body .citi-dish .logo-citi {
              text-align: center; }
          .students .content .modal-fullscreen div.modal-content div.modal-body .link-booking {
            padding-top: 20px;
            text-align: center; }
            .students .content .modal-fullscreen div.modal-content div.modal-body .link-booking a {
              color: #FFBE22;
              font-weight: bold; }
          ...
          .students .content .modal-fullscreen div.modal-content div.modal-body p {
            ...
            line-height: 1.42857143;
            min-height: 22px; }
            .students .content .modal-fullscreen div.modal-content div.modal-body p:last-child {
              margin-bottom: 0; }
...
/*# sourceMappingURL=students-list.css.map */
